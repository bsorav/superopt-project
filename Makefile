...
linkinstall::
	...
	$(SUDO) ln -sf $(SUPEROPT_PROJECT_DIR)/superopt/build/etfg_x64/spec2tfg $(SUPEROPT_INSTALL_DIR)/bin
...
release::
	...
	rsync -Lrtv $(SUPEROPT_PROJECT_DIR)/superopt/build/etfg_x64/spec2tfg $(SUPEROPT_INSTALL_FILES_DIR)/bin
