...
git -C / clone --recurse-submodules https://compilerai-bot:SaouK7or7nJwUBIRDNF9@github.com/bsorav/superopt-project && git -C /superopt-project submodule update --init --recursive
