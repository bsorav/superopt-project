...
if __name__ == '__main__':
    ...
    short_tab =  gen_detailed_table(args.dir + '/bzip2_O1-.csv', target_functions)
    print(short_tab)

    long_tab = gen_passing_latex_table([args.dir + '/bzip2_O1-.csv', args.dir + '/bzip2_O1.csv', args.dir + '/bzip2_O2.csv'])
    print(long_tab)
